...
Reference Compose stack for the subscription-service. Used for our own development on the-deploy-host and as the artifact self-installers (hosting model 4) consume.
