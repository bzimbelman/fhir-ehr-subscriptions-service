...
1. **Docker Compose on the-deploy-host** — fastest path to running; reuses the existing Cloudflare tunnel that already fronts `*.bzonfhir.com`. Good for development, demos, and a single-node deployment.
